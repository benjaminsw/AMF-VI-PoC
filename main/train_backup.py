        ...
        with torch.no_grad():
            ...
            try:
                ...
                if save_plots:
                    ...
                    plot_path = os.path.join(results_dir, f'amf_vi_results_{dataset_name}.png')
                    fig_comprehensive.savefig(plot_path, dpi=300, bbox_inches='tight')
...
if __name__ == "__main__":
    ...
    results = train_amf_vi(
        show_plots=False,    # Set to False to skip showing plots
